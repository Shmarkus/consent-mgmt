...
class ServiceResourceTest {
    ...
    void setUp() {
        ...
        final ServiceDeclarationResponse response = new ServiceDeclarationResponse();
        response.setResponse("OK");
        doReturn(response).when(mockServiceService).save(any());
    ...
    @Test
    void shouldNotAddServiceDeclaration_serviceThrowsError() throws Exception {
